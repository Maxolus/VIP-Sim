...
namespace VisSim
{
    ...
    {
        [Linkable, Range(0f, 1f), Tooltip("Strength used to apply the noise. 0 means no noise at all, 1 is full noise.")]
        public float Strength = 0.75f;
        
        [Linkable, Range(0f, 1f), Tooltip("Reduce the noise visibility in luminous areas.")]
        public float LumContribution = 0.75f;

        [Linkable, Tooltip("Whether or not to follow the point of gaze.")]
